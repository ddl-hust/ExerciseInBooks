//
// Created by YTB-002 on 2019/10/31.
//
/*
 * @brief sale_data 类实现，作为之后hash<>存储对象
 * @parm bookNo:书号
 * @parm units_sold:一本书价格
 * @parm revenue: 利润
 * */
#ifndef INC_16_62_SALE_DATA_H
#define INC_16_62_SALE_DATA_H
#include <string>

struct Sales_data; //前置申明
